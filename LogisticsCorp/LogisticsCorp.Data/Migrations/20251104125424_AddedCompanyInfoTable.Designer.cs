...
namespace LogisticsCorp.Data.Migrations
{
    ...
    [Migration("20251104125424_AddedCompanyInfoTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LogisticsCorp.Data.Models.Account", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("LogisticsCorp.Data.Models.CompanyInfo", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("SaturdaySchedule")
                        .IsRequired()
                        .HasColumnType("text");

                    b.Property<string>("SundaySchedule")
                        .IsRequired()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("LogisticsCorp.Data.Models.RefreshToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("LogisticsCorp.Data.Models.Client", b =>
                {
                    b.HasBaseType("LogisticsCorp.Data.Models.Account");
            ...
            modelBuilder.Entity("LogisticsCorp.Data.Models.User", b =>
                {
                    b.HasOne("LogisticsCorp.Data.Models.Account", "Account")
                        .WithOne("User")
                        .HasForeignKey("LogisticsCorp.Data.Models.User", "AccountId")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("LogisticsCorp.Data.Models.Client", b =>
                {
                    b.HasOne("LogisticsCorp.Data.Models.Account", null)
                        .WithOne()
                        .HasForeignKey("LogisticsCorp.Data.Models.Client", "Id")
            ...
            modelBuilder.Entity("LogisticsCorp.Data.Models.Employee", b =>
                {
                    b.HasOne("LogisticsCorp.Data.Models.Account", null)
                        .WithOne()
                        .HasForeignKey("LogisticsCorp.Data.Models.Employee", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
